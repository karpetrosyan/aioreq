...
class TestUrlParser:
    ...
    @pytest.mark.parametrize(
            ...
            argvalues = [
                ...
                ("https://test.test.test/path/pathtwo/pathtree", "https", "test", "test", "test", "/path/pathtwo/pathtree", None, None),
                ("https://test.test.test/path?a=2&f=3&f=4", "https", "test", "test", "test", "/path", "a=2&f=3&f=4", None),
                ("https://test.test.test/path?a=2&f=3&f=4#testfragment", "https", "test", "test", "test", "/path", "a=2&f=3&f=4", "testfragment"),
                ("https://test.test.test/?a=2&f=3&f=4#testfragment", "https", "test", "test", "test", '/', "a=2&f=3&f=4", "testfragment"),
                ("https://test.test.test/#testfragment", "https", "test", "test", "test", '/', None, "testfragment"),
                ("https://test.test.test/pathone/pathtwo/pathtree?a=2&c=3&l=3#testfragment", "https", "test", "test", "test", "/pathone/pathtwo/pathtree", "a=2&c=3&l=3", "testfragment"),
            ]
            )
